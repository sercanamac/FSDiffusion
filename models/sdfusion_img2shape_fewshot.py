...
class SDFusionImage2ShapeModel(BaseModel):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        loss_vlb = (self.lvlb_weights[t.to("cpu")].to("cuda") * loss_vlb).mean()
    ...
    def get_current_visuals(self):
        ...
        with torch.no_grad():
            ...
            self.img_gen_df = render_sdf(self.renderer, self.gen_df.to(self.device)) # rendered generated sdf
            if self.gen_gt != None:
                self.img_gen_gt = render_sdf(self.renderer, self.gen_gt.to(self.device))
        vis_tensor_names = [
            'img',
            'img_gt',
            'img_gen_df',
